...
//std::string PdalToCc::getName() const { return "converters.pdal_to_cc"; }
//const pdal::expr::ConditionalExpression *PdalToCc::whereExpr() const {
//  return nullptr;
//}
//pdal::Stage::WhereMergeMode PdalToCc::mergeMode() const {
